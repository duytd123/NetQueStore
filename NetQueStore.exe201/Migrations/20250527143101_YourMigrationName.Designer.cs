...
namespace NetQueStore.exe201.Migrations
{
    ...
    [Migration("20250527143101_YourMigrationName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetQueStore.exe201.Models.CustomerGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NetQueStore.exe201.Models.GuestOrdersTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NetQueStore.exe201.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NetQueStore.exe201.Models.OutOfStockNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OutOfStockNotification");
                });
            ...
            modelBuilder.Entity("NetQueStore.exe201.Models.VnpayPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__vnpay_pa__3213E83FEC94D892");

                    b.HasIndex(new[] { "OrderId", "TransactionId" }, "FK_vnpay_order_transaction")
                        .IsUnique();

                    b.HasIndex(new[] { "TransactionId" }, "UQ__vnpay_pa__85C600AE3D95F5C2")
                        .IsUnique();

                    b.ToTable("vnpay_payments", (string)null);
                });
            ...
            modelBuilder.Entity("CustomerGroupUser", b =>
                {
                    b.HasOne("NetQueStore.exe201.Models.CustomerGroup", null)
                        .WithMany()
                        .HasForeignKey("GroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NetQueStore.exe201.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NetQueStore.exe201.Models.OutOfStockNotification", b =>
                {
                    b.HasOne("NetQueStore.exe201.Models.Food", "Food")
                        .WithMany("OutOfStockNotifications")
                        .HasForeignKey("FoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NetQueStore.exe201.Models.Food", b =>
                {
                    ...
                    b.Navigation("OutOfStockNotifications");
            ...
            modelBuilder.Entity("NetQueStore.exe201.Models.Order", b =>
                {
                    b.Navigation("GuestOrdersTrackings");
